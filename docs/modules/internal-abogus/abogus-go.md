...
> package `abogus` &nbsp;·&nbsp; 295 行 &nbsp;·&nbsp; 源码版本 main @ b252442 (2026-09-03)
...
### `ctx`  <span class=lineno>L11</span>
...
### `encryptionUa`  <span class=lineno>L18</span>
...
### `abArr256`  <span class=lineno>L44</span>
...
### `uaArr256`  <span class=lineno>L58</span>

```go
func uaArr256(uaSalt int) []int
```

### `garble`  <span class=lineno>L72</span>

```go
func garble(arr256, input []int) []int
```

### `uaGarbledCharacters`  <span class=lineno>L87</span>

```go
func uaGarbledCharacters(ua []int, uaSalt int) []int
```
