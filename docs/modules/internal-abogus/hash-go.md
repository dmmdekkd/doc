...
> package `abogus` &nbsp;·&nbsp; 165 行 &nbsp;·&nbsp; 源码版本 main @ b252442 (2026-09-03)


## Types

### `sm3reg`  <span class=lineno>L36</span>
...
### `ctRotl`  <span class=lineno>L6</span>
...
### `stConst`  <span class=lineno>L14</span>

```go
func stConst(e int) uint32
```

### `ktFF`  <span class=lineno>L21</span>

```go
func ktFF(e int, t, r, n uint32) uint32
```

### `xtGG`  <span class=lineno>L28</span>

```go
func xtGG(e int, t, r, n uint32) uint32
```

### `newReg`  <span class=lineno>L42</span>

```go
func newReg() *sm3reg
```

### `getArr`  <span class=lineno>L134</span>
...
### `codesOf`  <span class=lineno>L156</span>
...
### `getArrStr`  <span class=lineno>L165</span>

```go
func getArrStr(s string) []int
```
...
#### `compress`  <span class=lineno>L48</span>

```go
func (g *sm3reg) compress(r []int)
```

#### `write`  <span class=lineno>L87</span>

```go
func (g *sm3reg) write(o []int)
```

#### `fill`  <span class=lineno>L114</span>
