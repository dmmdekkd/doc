...
> package `login` &nbsp;·&nbsp; 121 行 &nbsp;·&nbsp; 源码版本 main @ b252442 (2026-09-03)
...
### `SMSLogin`  <span class=lineno>L16</span>
...
### `formatMobile`  <span class=lineno>L92</span>
...
### `errDesc`  <span class=lineno>L109</span>
