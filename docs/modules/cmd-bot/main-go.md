...
> package `main` &nbsp;·&nbsp; 449 行 &nbsp;·&nbsp; 源码版本 main @ b252442 (2026-09-03)
...
### `main`  <span class=lineno>L36</span>

```go
func main()
```

### `runSmoke`  <span class=lineno>L52</span>
...
### `contains`  <span class=lineno>L93</span>

```go
func contains(a []string, s string) bool
```

### `terminalHooks`  <span class=lineno>L102</span>

```go
func terminalHooks() login.Hooks
```

### `saveQRPng`  <span class=lineno>L135</span>
...
### `loginAndSave`  <span class=lineno>L160</span>
...
### `runLogin`  <span class=lineno>L182</span>

```go
func runLogin()
```

### `runCli`  <span class=lineno>L200</span>

```go
func runCli()
```

### `onIncoming`  <span class=lineno>L299</span>
...
### `runEngineLoop`  <span class=lineno>L316</span>
...
### `relogin`  <span class=lineno>L366</span>
...
### `capDur`  <span class=lineno>L377</span>

```go
func capDur(d, max time.Duration) time.Duration
```

### `stdinSender`  <span class=lineno>L385</span>
...
### `runSelfTest`  <span class=lineno>L411</span>
