...
> package `sign` &nbsp;·&nbsp; 88 行 &nbsp;·&nbsp; 源码版本 main @ b252442 (2026-09-03)
...
- **`AppKey`**  <span class=lineno>L17</span>
...
### `Xor5`  <span class=lineno>L21</span>
...
### `CodeEncrypt`  <span class=lineno>L47</span>

CodeEncrypt 别名（短信验证码加密）。

```go
func CodeEncrypt(s string) string
```
