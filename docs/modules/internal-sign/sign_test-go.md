...
> package `sign` &nbsp;·&nbsp; 42 行 &nbsp;·&nbsp; 源码版本 main @ b252442 (2026-09-03)
...
### `TestXor5`  <span class=lineno>L6</span>
...
### `TestSignParams`  <span class=lineno>L12</span>

```go
func TestSignParams(t *testing.T)
```

### `TestMsToken`  <span class=lineno>L38</span>
