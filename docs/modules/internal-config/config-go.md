...
> package `config` &nbsp;·&nbsp; 101 行 &nbsp;·&nbsp; 源码版本 main @ b252442 (2026-09-03)
...
### `Account`  <span class=lineno>L15</span>
...
- **`Dir`**  <span class=lineno>L12</span>
...
### `CookiePath`  <span class=lineno>L29</span>
