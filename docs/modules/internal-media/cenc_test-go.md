# `internal/media/cenc_test.go`

> package `media` &nbsp;·&nbsp; 74 行 &nbsp;·&nbsp; 源码版本 main @ b252442 (2026-09-03)
...
### `TestCENCSampleRoundTrip`  <span class=lineno>L11</span>
...
### `TestCENCWholeSampleRoundTrip`  <span class=lineno>L41</span>
...
### `TestCENCCounterContinuity`  <span class=lineno>L57</span>
