# `internal/media/videoserver_test.go`

> package `media` &nbsp;·&nbsp; 92 行 &nbsp;·&nbsp; 源码版本 main @ b252442 (2026-09-03)
...
### `TestFetchVideoAndDecrypt`  <span class=lineno>L14</span>
...
### `TestFetchVideoBackupFallback`  <span class=lineno>L47</span>
...
### `TestFetchVideoRejectsNonHTTPS`  <span class=lineno>L71</span>

```go
func TestFetchVideoRejectsNonHTTPS(t *testing.T)
```

### `TestVideoLink`  <span class=lineno>L77</span>
