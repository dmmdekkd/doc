...
> package `media` &nbsp;·&nbsp; 59 行 &nbsp;·&nbsp; 源码版本 main @ b252442 (2026-09-03)
...
- **`maxVideoBytes`**  <span class=lineno>L15</span>
...
- **`videoHTTP`**  <span class=lineno>L17</span>
...
### `FetchVideoAndDecrypt`  <span class=lineno>L20</span>
...
### `fetchVideo`  <span class=lineno>L31</span>

```go
func fetchVideo(rawURL string) ([]byte, error)
```

### `VideoLink`  <span class=lineno>L51</span>
