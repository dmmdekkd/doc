...
> package `media` &nbsp;·&nbsp; 77 行 &nbsp;·&nbsp; 源码版本 main @ b252442 (2026-09-03)
...
- **`proxyBase`, `proxyMu`**  <span class=lineno>L14</span>
...
- **`allowedImageHosts`**  <span class=lineno>L20</span>
...
### `allowedImageHost`  <span class=lineno>L25</span>

```go
func allowedImageHost(rawURL string) bool
```

### `SetProxyBase`  <span class=lineno>L40</span>
...
### `ImageHandler`  <span class=lineno>L47</span>
...
### `ImageLink`  <span class=lineno>L69</span>
