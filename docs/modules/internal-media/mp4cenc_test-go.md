# `internal/media/mp4cenc_test.go`

> package `media` &nbsp;·&nbsp; 158 行 &nbsp;·&nbsp; 源码版本 main @ b252442 (2026-09-03)
...
### `TestDecryptVideoPayload`  <span class=lineno>L14</span>
...
### `assertMdatIntact`  <span class=lineno>L54</span>
...
### `assertFirstVideoSampleNAL`  <span class=lineno>L68</span>
...
### `firstVideoSample`  <span class=lineno>L89</span>
...
### `ffprobeCheck`  <span class=lineno>L122</span>

```go
func ffprobeCheck(t *testing.T, path string)
```

### `ffmpegDecodeCheck`  <span class=lineno>L141</span>
