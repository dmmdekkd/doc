...
> package `media` &nbsp;·&nbsp; 102 行 &nbsp;·&nbsp; 源码版本 main @ b252442 (2026-09-03)
...
### `ImageResource`  <span class=lineno>L15</span>
...
### `DecryptImage`  <span class=lineno>L25</span>
...
### `SniffExt`  <span class=lineno>L57</span>
...
### `sniffMime`  <span class=lineno>L72</span>

```go
func sniffMime(b []byte) string
```

### `FetchAndDecrypt`  <span class=lineno>L88</span>
...
#### `PickURL`  <span class=lineno>L47</span>
