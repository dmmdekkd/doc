...
> package `media` &nbsp;·&nbsp; 63 行 &nbsp;·&nbsp; 源码版本 main @ b252442 (2026-09-03)
...
### `TestDecryptImageRoundTrip`  <span class=lineno>L12</span>

```go
func TestDecryptImageRoundTrip(t *testing.T)
```

### `TestImageLink`  <span class=lineno>L36</span>

```go
func TestImageLink(t *testing.T)
```

### `TestAllowedImageHost`  <span class=lineno>L50</span>
