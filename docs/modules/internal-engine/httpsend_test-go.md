# `internal/engine/httpsend_test.go`

> package `engine` &nbsp;·&nbsp; 100 行 &nbsp;·&nbsp; 源码版本 main @ b252442 (2026-09-03)
...
### `TestBuildIMAPIBodyMatchesHAR`  <span class=lineno>L11</span>
...
### `TestParseSendResponse`  <span class=lineno>L65</span>
...
### `TestImageContentShape`  <span class=lineno>L81</span>
