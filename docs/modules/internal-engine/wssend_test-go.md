# `internal/engine/wssend_test.go`

> package `engine` &nbsp;·&nbsp; 150 行 &nbsp;·&nbsp; 源码版本 main @ b252442 (2026-09-03)
...
### `TestBuildWSSendPayloadGroup`  <span class=lineno>L9</span>
...
### `TestWSAdaptContent`  <span class=lineno>L75</span>
...
### `TestBuildWSSendPayloadImageMsgType`  <span class=lineno>L95</span>
...
### `TestMatchSendAck`  <span class=lineno>L109</span>
