...
> package `engine` &nbsp;·&nbsp; 298 行 &nbsp;·&nbsp; 源码版本 main @ b252442 (2026-09-03)
...
### `ProtoField`  <span class=lineno>L14</span>
...
### `encodeVarint`  <span class=lineno>L26</span>
...
### `encodeTag`  <span class=lineno>L35</span>

```go
func encodeTag(fieldNum, wireType int) []byte
```

### `encodeFieldVarint`  <span class=lineno>L39</span>

```go
func encodeFieldVarint(fieldNum int, value uint64) []byte
```

### `encodeLenDelim`  <span class=lineno>L43</span>

```go
func encodeLenDelim(fieldNum int, data []byte) []byte
```

### `encodeLenDelimS`  <span class=lineno>L49</span>

```go
func encodeLenDelimS(fieldNum int, s string) []byte
```

### `encodeKvPair`  <span class=lineno>L53</span>

```go
func encodeKvPair(fieldNum int, key, value string) []byte
```

### `concat`  <span class=lineno>L58</span>

```go
func concat(parts ...[]byte) []byte
```

### `decodeVarintAt`  <span class=lineno>L69</span>
...
### `tryUtf8`  <span class=lineno>L89</span>
...
### `decodeProtobuf`  <span class=lineno>L102</span>
