...
> package `engine` &nbsp;·&nbsp; 721 行 &nbsp;·&nbsp; 源码版本 main @ b252442 (2026-09-03)
...
### `ImImage`  <span class=lineno>L48</span>
...
### `ImVideo`  <span class=lineno>L72</span>
...
### `ImEmoji`  <span class=lineno>L83</span>
...
### `IncomingMessage`  <span class=lineno>L93</span>
...
### `Client`  <span class=lineno>L107</span>
...
- **`androidSendWsBase`, `akFpID`, `akAppKey`, `akSalt`, `awemeAID`, `awemeVersionCode`, `awemeVersionName`, `awemeUpdateVersionCode`, `awemeChannel`, `awemeDeviceType`, `awemeDeviceBrand`, `awemeOSVersion`, `awemeOSAPI`, `awemeAppName`, `awemeAppPackage`, `awemeUA`, `awemeSDKVersion`, `awemeBuildNumber2`**  <span class=lineno>L20</span>
...
### `New`  <span class=lineno>L130</span>
...
#### `resolveShort`  <span class=lineno>L119</span>
...
#### `nextSeq`  <span class=lineno>L134</span>
...
#### `PickURL`  <span class=lineno>L62</span>
