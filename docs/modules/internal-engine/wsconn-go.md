...
> package `engine` &nbsp;·&nbsp; 224 行 &nbsp;·&nbsp; 源码版本 main @ b252442 (2026-09-03)
...
### `WsProxy`  <span class=lineno>L19</span>
...
### `WsConn`  <span class=lineno>L28</span>
...
- **`maxFrameBytes`**  <span class=lineno>L25</span>
...
### `wsConnect`  <span class=lineno>L39</span>
...
### `applyProxy`  <span class=lineno>L88</span>
...
#### `reader`  <span class=lineno>L126</span>

```go
func (c *WsConn) reader()
```

#### `setClosed`  <span class=lineno>L141</span>

```go
func (c *WsConn) setClosed(err error)
```

#### `err`  <span class=lineno>L153</span>

```go
func (c *WsConn) err() error
```

#### `IsOpen`  <span class=lineno>L161</span>
