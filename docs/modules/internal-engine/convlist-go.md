...
> package `engine` &nbsp;·&nbsp; 139 行 &nbsp;·&nbsp; 源码版本 main @ b252442 (2026-09-03)
...
### `ConvMember`  <span class=lineno>L13</span>
...
### `Conversation`  <span class=lineno>L20</span>
...
- **`imapiConvListURL`**  <span class=lineno>L10</span>
...
### `parseConvListResp`  <span class=lineno>L58</span>
...
### `parseConversation`  <span class=lineno>L70</span>

```go
func parseConversation(cv []ProtoField) Conversation
```

### `childMsgs`  <span class=lineno>L104</span>
...
### `firstMsg`  <span class=lineno>L114</span>

```go
func firstMsg(fields []ProtoField, num int) []ProtoField
```

### `firstStr`  <span class=lineno>L123</span>

```go
func firstStr(fields []ProtoField, num int) string
```

### `firstVarint`  <span class=lineno>L132</span>
...
#### `ListConversations`  <span class=lineno>L32</span>
