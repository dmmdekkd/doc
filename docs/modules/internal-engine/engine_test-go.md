...
> package `engine` &nbsp;·&nbsp; 173 行 &nbsp;·&nbsp; 源码版本 main @ b252442 (2026-09-03)
...
### `mustJSON`  <span class=lineno>L11</span>

```go
func mustJSON(t *testing.T, raw string, v any)
```

### `md5Ref`  <span class=lineno>L18</span>

```go
func md5Ref(s string) string
```

### `TestKvPairRoundTrip`  <span class=lineno>L24</span>
...
### `TestVarintRoundTrip`  <span class=lineno>L37</span>
...
### `TestBuildAndCollectRoundTrip`  <span class=lineno>L48</span>
...
### `TestJSONNoEscape`  <span class=lineno>L73</span>
...
### `TestParseImageItem`  <span class=lineno>L87</span>
...
### `TestParseImageNoText`  <span class=lineno>L105</span>
...
### `TestSelfDirection`  <span class=lineno>L136</span>
...
### `TestAccessKey`  <span class=lineno>L147</span>
...
### `TestRawURLEncode`  <span class=lineno>L160</span>
