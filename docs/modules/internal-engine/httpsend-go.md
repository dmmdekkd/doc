...
> package `engine` &nbsp;·&nbsp; 229 行 &nbsp;·&nbsp; 源码版本 main @ b252442 (2026-09-03)
...
### `imapiTextContent`  <span class=lineno>L56</span>
...
### `ImageAsset`  <span class=lineno>L64</span>
...
### `imapiImageContent`  <span class=lineno>L74</span>
...
- **`imapiSendURL`, `imapiRecallURL`, `imapiPropURL`, `webSDKVersion`, `webBuildNumber`, `webSessionAID`, `webAppName`, `webBiz`, `webAccess`, `pcUA`**  <span class=lineno>L17</span>
...
- **`convTypeSingle`, `convTypeGroup`**  <span class=lineno>L31</span>
...
- **`msgTypeText`, `msgTypeEmoji`, `msgTypeImage`, `msgTypeVideo`**  <span class=lineno>L37</span>
...
- **`imHTTP`, `uploadHTTP`**  <span class=lineno>L50</span>
...
### `isGroupConv`  <span class=lineno>L45</span>
...
### `fingerprintKVs`  <span class=lineno>L97</span>
...
### `u64str`  <span class=lineno>L217</span>

```go
func u64str(v uint64) string
```

### `snippet`  <span class=lineno>L224</span>
...
#### `deviceID`  <span class=lineno>L89</span>

```go
func (c *Client) deviceID() string
```

#### `buildEnvelope`  <span class=lineno>L109</span>
...
#### `buildIMAPIBody`  <span class=lineno>L134</span>
...
#### `postIMAPIRaw`  <span class=lineno>L152</span>
...
#### `resolveConvSend`  <span class=lineno>L175</span>
...
#### `dispatchSend`  <span class=lineno>L187</span>
...
#### `sendIMAPI`  <span class=lineno>L195</span>
