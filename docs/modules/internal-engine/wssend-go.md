...
> package `engine` &nbsp;·&nbsp; 293 行 &nbsp;·&nbsp; 源码版本 main @ b252442 (2026-09-03)
...
### `wsCh1TextContent`  <span class=lineno>L29</span>
...
### `wsAck`  <span class=lineno>L210</span>
...
- **`wsSendBiz`, `wsSendAccess`**  <span class=lineno>L22</span>
...
- **`androidSendExt12`**  <span class=lineno>L199</span>
...
### `wsAdaptContent`  <span class=lineno>L42</span>
...
### `wrapAndroidCmd100Outer`  <span class=lineno>L153</span>
...
### `androidSendExt`  <span class=lineno>L173</span>
...
### `matchSendAck`  <span class=lineno>L236</span>

```go
func matchSendAck(top []ProtoField, wantCmid string, ack *wsAck) bool
```

### `blockedCallback`  <span class=lineno>L264</span>

```go
func blockedCallback(code string) bool
```

### `collectKV`  <span class=lineno>L273</span>
...
#### `sendViaWS`  <span class=lineno>L65</span>
...
#### `buildWSSendPayload`  <span class=lineno>L97</span>
...
#### `buildAndroidCmd100Inner`  <span class=lineno>L123</span>
...
#### `drainSendAck`  <span class=lineno>L218</span>
