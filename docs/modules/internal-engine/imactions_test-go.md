# `internal/engine/imactions_test.go`

> package `engine` &nbsp;·&nbsp; 96 行 &nbsp;·&nbsp; 源码版本 main @ b252442 (2026-09-03)
...
### `TestRecallBodyMatchesHAR`  <span class=lineno>L11</span>
...
### `TestEmojiContent`  <span class=lineno>L40</span>
...
### `TestReplyContent`  <span class=lineno>L62</span>
...
#### `buildEmojiContentForTest`  <span class=lineno>L89</span>
