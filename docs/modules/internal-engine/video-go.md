...
> package `engine` &nbsp;·&nbsp; 187 行 &nbsp;·&nbsp; 源码版本 main @ b252442 (2026-09-03)
...
### `imapiVideoContent`  <span class=lineno>L17</span>
...
- **`videoPartSize`**  <span class=lineno>L15</span>
...
#### `SendVideoResult`  <span class=lineno>L34</span>
...
#### `uploadVideo`  <span class=lineno>L77</span>
...
#### `chunkInit`  <span class=lineno>L108</span>
...
#### `chunkTransfer`  <span class=lineno>L135</span>
...
#### `chunkFinish`  <span class=lineno>L157</span>
...
#### `uploadCheckPic`  <span class=lineno>L177</span>
