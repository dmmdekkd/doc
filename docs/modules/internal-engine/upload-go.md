...
> package `engine` &nbsp;·&nbsp; 301 行 &nbsp;·&nbsp; 源码版本 main @ b252442 (2026-09-03)
...
### `stsCreds`  <span class=lineno>L35</span>
...
- **`uploadConfigURL`, `vodBase`, `vodRegion`, `vodService`**  <span class=lineno>L28</span>
...
### `vodSignedRequest`  <span class=lineno>L213</span>
...
### `vodSign`  <span class=lineno>L234</span>
...
### `canonicalQuery`  <span class=lineno>L270</span>
...
### `sha256Hex`  <span class=lineno>L283</span>
...
#### `UploadImage`  <span class=lineno>L43</span>
...
#### `getUploadConfig`  <span class=lineno>L75</span>
...
#### `applyUpload`  <span class=lineno>L106</span>
...
#### `tosPut`  <span class=lineno>L153</span>
...
#### `commitUpload`  <span class=lineno>L178</span>
