...
> package `engine` &nbsp;·&nbsp; 81 行 &nbsp;·&nbsp; 源码版本 main @ b252442 (2026-09-03)
...
### `VideoURL`  <span class=lineno>L39</span>
...
- **`batchPlayInfoURL`**  <span class=lineno>L14</span>
...
#### `pcFingerprintQuery`  <span class=lineno>L17</span>
...
#### `ResolveVideoURL`  <span class=lineno>L46</span>
