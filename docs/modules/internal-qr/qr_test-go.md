...
> package `qr` &nbsp;·&nbsp; 110 行 &nbsp;·&nbsp; 源码版本 main @ b252442 (2026-09-03)
...
### `renderMatrixImage`  <span class=lineno>L15</span>
...
### `goqrRecognize`  <span class=lineno>L38</span>

```go
func goqrRecognize(img image.Image) ([][]byte, error)
```

### `TestDecodeRealDouyinQR`  <span class=lineno>L50</span>

```go
func TestDecodeRealDouyinQR(t *testing.T)
```

### `TestRenderMatrixScannable`  <span class=lineno>L98</span>
