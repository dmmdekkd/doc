...
> package `gateway` &nbsp;·&nbsp; 772 行 &nbsp;·&nbsp; 源码版本 main @ b252442 (2026-09-03)
...
### `accountStatus`  <span class=lineno>L35</span>
...
### `wsClient`  <span class=lineno>L46</span>
...
### `Sender`  <span class=lineno>L109</span>
...
### `Gateway`  <span class=lineno>L122</span>
...
- **`protocolVersion`**  <span class=lineno>L32</span>

  ```go
  const protocolVersion = 1
  ```

- **`maxBody`**  <span class=lineno>L33</span>
...
### `newWsClient`  <span class=lineno>L53</span>

```go
func newWsClient(conn *websocket.Conn, queueLimit int) *wsClient
```

### `New`  <span class=lineno>L140</span>
...
#### `handler`  <span class=lineno>L151</span>
...
#### `Start`  <span class=lineno>L166</span>
...
#### `Stop`  <span class=lineno>L178</span>
...
#### `linkAddr`  <span class=lineno>L193</span>
...
#### `Addr`  <span class=lineno>L202</span>
...
#### `writeLoop`  <span class=lineno>L62</span>

```go
func (c *wsClient) writeLoop()
```

#### `push`  <span class=lineno>L86</span>
...
#### `close`  <span class=lineno>L101</span>
