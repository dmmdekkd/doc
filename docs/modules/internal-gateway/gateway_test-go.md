...
> package `gateway` &nbsp;·&nbsp; 364 行 &nbsp;·&nbsp; 源码版本 main @ b252442 (2026-09-03)
...
### `fakeSender`  <span class=lineno>L20</span>
...
### `newTestGW`  <span class=lineno>L78</span>

```go
func newTestGW() (*Gateway, *fakeSender)
```

### `post`  <span class=lineno>L85</span>

```go
func post(t *testing.T, base, path, token, body string) (int, map[string]any)
```

### `TestHealthNoAuth`  <span class=lineno>L102</span>

```go
func TestHealthNoAuth(t *testing.T)
```

### `TestAuth`  <span class=lineno>L122</span>

```go
func TestAuth(t *testing.T)
```

### `TestUnknownAndMethod`  <span class=lineno>L137</span>

```go
func TestUnknownAndMethod(t *testing.T)
```

### `TestSendTextValidationAndSuccess`  <span class=lineno>L151</span>

```go
func TestSendTextValidationAndSuccess(t *testing.T)
```

### `TestSendImage`  <span class=lineno>L176</span>

```go
func TestSendImage(t *testing.T)
```

### `TestWebSocketHelloPongAndEvent`  <span class=lineno>L193</span>

```go
func TestWebSocketHelloPongAndEvent(t *testing.T)
```

### `TestOriWsRawFrame`  <span class=lineno>L226</span>

```go
func TestOriWsRawFrame(t *testing.T)
```

### `TestEmitSelf`  <span class=lineno>L259</span>

```go
func TestEmitSelf(t *testing.T)
```

### `TestVideoProxyValidation`  <span class=lineno>L299</span>
...
### `TestGetVideoURLPlayLink`  <span class=lineno>L328</span>
...
### `TestWebSocketBadToken`  <span class=lineno>L350</span>
