...
> package `webapi` &nbsp;·&nbsp; 138 行 &nbsp;·&nbsp; 源码版本 main @ b252442 (2026-09-03)
...
### `User`  <span class=lineno>L23</span>
...
- **`webHTTP`**  <span class=lineno>L18</span>
...
### `encodeKV`  <span class=lineno>L25</span>

```go
func encodeKV(m map[string]string) string
```

### `FetchUserInfo`  <span class=lineno>L34</span>
...
### `uidStr`  <span class=lineno>L95</span>

```go
func uidStr(v any) string
```

### `ResolveUsers`  <span class=lineno>L106</span>
